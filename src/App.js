...
let heroes = JSON.parse(superHeroes);
...
function App() {
  return (
    <div className="App">
      {
        heroes.map((hero) =>
          <Hero name={hero.name} universe={hero.universe} alterego={hero.alterego} occupation={hero.occupation} friends={hero.friends} info={hero.info} url={hero.url} ></Hero>
        )
      }
      <Star></Star>
    </div >
